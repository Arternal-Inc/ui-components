  ...
  <component
    ...
    :class="{
      ...
      'bg-secondary-400 text-white hover:bg-secondary-500':
        !isDisabled && !outline && !borderless && variant === 'secondary',
      'bg-primary-500 text-white hover:bg-primary-600':
        !isDisabled && !outline && !borderless && variant === 'primary',
      'bg-danger-500 text-white hover:bg-danger-600':
        !isDisabled && !outline && !borderless && variant === 'danger',
      'bg-warning-500 text-white hover:bg-warning-600':
        !isDisabled && !outline && !borderless && variant === 'warning',
      'bg-success-500 text-white hover:bg-success-600':
        !isDisabled && !outline && !borderless && variant === 'success',
      'bg-info-400 text-white hover:bg-info-500':
        !isDisabled && !outline && !borderless && variant === 'info',

      'border-transparent': !outline,
      '!border-transparent': borderless,

      'border-secondary-600 text-secondary-600 hover:bg-secondary-50 hover:text-primary-600 hover:border-primary-600':
        !isDisabled && (outline || borderless) && variant === 'secondary',
      ...
      'cursor-not-allowed bg-disabled-100 text-disabled-400 focus:ring-0':
        isDisabled,
    }"
  >
    <slot />
