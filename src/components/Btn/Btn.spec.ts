...
describe('Btn component', () => {
  ...
  describe(':size property', () => {
    ...
    it.todo('should display a medium button on invalid value')
  ...
  describe(':variant property', () => {
    ...
    it.todo('should display a secondary button on invalid value')
  ...
  describe('@click event', () => {
    it.todo('should be able to click')

    it.todo('should not be able to click when disabled')
  })
})
